    ...
    <ThemedView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      >
        ...
        <Card>
          ...
          {renderPoint(
            "Global Presence",
            "Serving clients across 150+ countries with extensive logistics capabilities."
          )}
          {renderPoint(
            "Reliable Operations",
            "Built on transparency, technology, and trusted international partnerships."
          )}
        </Card>
        ...
        <Card>
          ...
          {renderPoint(
            "Real-time Tracking",
            "Complete visibility into every shipment across 150+ countries."
          )}
          {renderPoint(
            "24/7 Support",
            "Multilingual support team ready to assist anytime."
          )}
          {renderPoint(
            "Competitive Rates",
            "Best rates negotiated directly with carriers worldwide."
          )}
        </Card>
      </ScrollView>
    </ThemedView>
